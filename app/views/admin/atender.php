        ...
        <div class="col-sm-12 col-md-10 col-lg-8">
            ...
            <div class="row">
                ...
                <div class="form-row col-lg-12">
                    ...
                    <div class="form-group col-lg-5 col-md-10 col-sm-12 text-right">
                        <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#modalAtender">Detalhes
                        </button>

                        <a class="btn btn-danger"
                           href="<?php echo URL_BASE . 'chamado/prioridade/' . $chamado->id_chamado ?>">
                            Prioridade
                        </a>
                    </div>
                </div>
